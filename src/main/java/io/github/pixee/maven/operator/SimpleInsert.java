...
public class SimpleInsert implements Command {
    ...
    public boolean execute(ProjectModel pm) {
        List<Node> dependencyManagementNodeList = Util.selectXPathNodes(pm.getPomFile().getResultPom(), "/m:project/m:dependencyManagement");
        ...
        List<Node> dependenciesNodeList = Util.selectXPathNodes(pm.getPomFile().getResultPom(), "//m:project/m:dependencies");

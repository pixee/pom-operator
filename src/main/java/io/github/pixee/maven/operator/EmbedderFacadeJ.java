...
public class EmbedderFacadeJ {
    ...
    private static EmbedderFacadeJ instance = new EmbedderFacadeJ();
    private static final Logger LOGGER = LoggerFactory.getLogger(EmbedderFacadeJ.class);

    private EmbedderFacadeJ() {
    }

    public static EmbedderFacadeJ getInstance() {
        return instance;
    }

    public static EmbedderFacadeJ.EmbedderFacadeResponse invokeEmbedder(EmbedderFacadeJ.EmbedderFacadeRequest req) throws ModelBuildingException {
        File localRepoPath;
        ...
        return new EmbedderFacadeJ.EmbedderFacadeResponse(
                modelBuildingResult,
                session,
                repositorySystem,
                remoteRepositories
    ...
    public static class EmbedderFacadeResponse {
        ...
        public EmbedderFacadeResponse(ModelBuildingResult modelBuildingResult,

...
public class POMOperatorJ {
     ...
     * @param projectModel Project Model (Context) Class
     */
    public static Collection<DependencyJ> queryDependency(ProjectModelJ projectModel) {
     ...
     */
    public static Collection<DependencyJ> queryDependency(ProjectModelJ projectModel, List<CommandJ> commandList) {

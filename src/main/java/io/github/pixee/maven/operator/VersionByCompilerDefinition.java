...
import static io.github.pixee.maven.operator.Util.selectXPathNodes;

public class VersionByCompilerDefinition extends AbstractVersionCommand {
    @Override
    public boolean execute(ProjectModel pm) {
        Set<VersionDefinition> definedSettings = new TreeSet<>(AbstractVersionCommand.VERSION_KIND_COMPARATOR);

...
public class EmbedderFacade {
    ...
    public static EmbedderFacade.EmbedderFacadeResponse invokeEmbedder(EmbedderFacade.EmbedderFacadeRequest req) throws ModelBuildingException {
        File localRepoPath;
        ...
        return new EmbedderFacade.EmbedderFacadeResponse(
                modelBuildingResult,
                session,
                repositorySystem,
                remoteRepositories

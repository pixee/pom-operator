...
public class FormatCommand extends AbstractCommand {
    ...
    private LinkedHashMap<Integer, MatchData> findSingleElementMatchesFrom(String xmlDocumentString) {
        ...
        while (iterator.hasNext()) {
            ...
            MatchData matchDataJ = new MatchData(
        ...
        List<Pair<Integer, MatchData>> allTags = emptyMappedTags.stream()
    ...
    private List<MatchData> getElementsToReplace(BitSet originalElementMap, POMDocument pom){
        ...
        Map<Integer, MatchData> singleElementMatches = findSingleElementMatchesFrom(new String(pom.getOriginalPom(),pom.getCharset()));
    ...
    private Map<Integer, MatchData> getEmptyElements(BitSet targetElementMap, String xmlRepresentation){
        ...
        for (Map.Entry<Integer, MatchData> entry : findSingleElementMatchesFrom(xmlRepresentation).entrySet()) {
    ...
    private byte[] serializePomFile(POMDocument pom) throws XMLStreamException {
        ...
        for (Map.Entry<Integer, MatchData> entry : emptyElements.entrySet()) {
            ...
            MatchData nextMatch = elementsToReplace.remove(0); // Assuming removeFirst() removes the first element.
